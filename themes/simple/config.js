const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>Người yêu lập trình<br/>/Người làm công nghệ<br/>/Blogger chia sẻ kiến thức</div>',
